...
def create_mini_dora():
    ...
    for image_file in image_files:
        ...
        if not os.path.exists(os.path.join(os.path.dirname(image_file),"mini_dora")):
            os.makedirs(os.path.join(os.path.dirname(image_file),"mini_dora"))
        
        cv2.imwrite(os.path.join(os.path.dirname(image_file),"mini_dora", os.path.basename(image_file)), image2)
